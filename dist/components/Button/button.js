...
export var Button = function (props) {
    var _a;
    var btnType = props.btnType, btnSize = props.btnSize, disabled = props.disabled, className = props.className, children = props.children, href = props.href, restProps = __rest(props, ["btnType", "btnSize", "disabled", "className", "children", "href"]);
